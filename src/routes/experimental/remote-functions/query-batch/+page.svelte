...
<article class="p-4 space-y-8">
	...
	<article class="card preset-filled-primary-200-800 divide-y divide-primary-300-700">
		<header class="p-4">
			<h2 class="text-primary-700-300">SvelteKit query.batch의 의의</h2>
		</header>
		
		<div class="p-4 space-y-6">
			<section>
				<h3 class="text-primary-700-300 mb-3">핵심 개념 (공식 문서)</h3>
			...
			<section>
				<h3 class="text-primary-700-300 mb-3">개발자 관점</h3>
			...
			<section>
				<h3 class="text-primary-700-300 mb-3">프레임워크 백그라운드</h3>
				<ul class="list-disc list-inside space-y-2 text-primary-600-400">
			...
			<section>
				<h3 class="text-primary-700-300 mb-3">비교</h3>
				<ul class="list-disc list-inside space-y-2 text-primary-600-400">
		...
		<footer class="p-4 preset-filled-primary-100-900">
			<h3 class="text-primary-700-300 mb-2">실제 활용</h3>
			<p class="text-primary-600-400">
