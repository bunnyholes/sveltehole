...
<main class="space-y-8 p-4">
	...
	<article class="divide-y divide-primary-300-700 card preset-filled-primary-200-800">
		...
		<div class="space-y-6 p-4">
			<section>
				<h3 class="preset-typo-title mb-3 text-primary-700-300">핵심 개념 (공식 문서)</h3>
				<p class="text-primary-600-400">
					"query.batch는 query와 동일하게 작동하지만, 동일한 매크로태스크 내에서 발생하는 요청들을
					배치 처리합니다."
				</p>
			</section>

			<section>
				<h3 class="preset-typo-title mb-3 text-primary-700-300">개발자 관점</h3>
				<ul class="list-inside list-disc space-y-2 text-primary-600-400">
					<li>
						사용법 - <code class="rounded preset-filled-primary-100-900 px-1 py-0.5"
							>getGuestbookItems(id)</code
						> - 단일 키 조회처럼 사용
					</li>
			...
			<section>
				<h3 class="preset-typo-title mb-3 text-primary-700-300">프레임워크 백그라운드</h3>
				<ul class="list-inside list-disc space-y-2 text-primary-600-400">
					<li>동일 매크로태스크의 모든 호출을 자동 수집</li>
					<li>N개 요청 → 1개 배치 요청으로 자동 변환</li>
					<li>
						<code class="rounded preset-filled-primary-100-900 px-1 py-0.5">WHERE id IN (...)</code>
						단일 쿼리로 최적화
					</li>
				</ul>
			</section>
			...
			<section>
				<h3 class="preset-typo-title mb-3 text-primary-700-300">비교</h3>
				<ul class="list-inside list-disc space-y-2 text-primary-600-400">
		...
		<footer class="preset-filled-primary-100-900 p-4">
			<h3 class="preset-typo-title mb-2 text-primary-700-300">실제 활용</h3>
			<p class="text-primary-600-400">
